...
This step is only required if you are going to perform the installation from the console, and not via SSH. Step 5 shows the steps to enable SSH access to the live environment. If you are going to connect to the live environment via SSH, the keymap and font from your SSH client will apply.
